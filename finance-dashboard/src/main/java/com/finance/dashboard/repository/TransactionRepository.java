...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT t FROM Transaction t WHERE t.deleted = false AND t.date >= :startDate ORDER BY t.date ASC")
    List<Transaction> findForTrends(@Param("startDate") LocalDate startDate);
